...
{
    /// <inheritdoc />
    public partial class initial_Create_seed : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Theatre_Cinema_CinemaId",
                        column: x => x.CinemaId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SeatNo = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
